...
IDT_PREPOPUPREPORTE_CONSOLIDADO = "j_idt98"
ID_FUNCIONALIDAD_CONSOLIDADO = "119"
IDT_PREREPORTE_CONSOLIDADO = "j_idt9"
...
def abrir_reportes(vs_main, s_login, c_login):  # Viewstate
    payload_Pre_PopUpReporte = (
        ...
        + IDT_PREPOPUPREPORTE_CONSOLIDADO
        + "%3AfnOpenItemMenu&javax.faces.partial.execute=%40all&"
        + IDT_PREPOPUPREPORTE_CONSOLIDADO
        + "%3AfnOpenItemMenu="
        + IDT_PREPOPUPREPORTE_CONSOLIDADO
        + "%3AfnOpenItemMenu&pFuncionalidadId="
        + ID_FUNCIONALIDAD_CONSOLIDADO
        + "&pPadreId=8&pIrPagina=http%3A%2F%2Fclreportes.comsatel.com.pe%2FCLReporte%2F&"
        + IDT_PREPOPUPREPORTE_CONSOLIDADO
        + "="
        + IDT_PREPOPUPREPORTE_CONSOLIDADO
    ...
    response_Pre_PopUpReporte = requests.request(
        "POST",
        COM_URL_MAIN,
        headers=headers_Pre_PopUpReporte,
        data=payload_Pre_PopUpReporte,
    )
    ...
    response_Pre_Reporte = requests.request(
        ...
        + s_CLReporte,
        headers=headers_Pre_Reporte,
        data=payload_Pre_Reporte,
    )
