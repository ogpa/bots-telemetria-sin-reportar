...
def generar_reporte_kilometraje_y_horas(periodo, sid):
    ...
    payload_Get_Report_Data = 'params=%7B%22itemId%22%3A25005170%2C%22col%22%3A%5B8%5D%2C%22flags%22%3A0%7D&sid=' + sid
    ...
    response_Get_Report_Data = requests.request("POST", url_Get_Report_Data,
                                                headers=headers_Get_Report_Data, data=payload_Get_Report_Data)

    # url_Seleccionar_Horas_Trabajadas = "https://hst-api.wialon.com/wialon/ajax.html?svc=report/get_report_data&sid=" + sid
    # payload_Seleccionar_Horas_Trabajadas = 'params=%7B%22itemId%22%3A25005170%2C%22col%22%3A%5B2%5D%2C%22flags%22%3A0%7D&sid=' + sid
    # headers_Seleccionar_Horas_Trabajadas = {
    #     'authority': 'hst-api.wialon.com',
    #     'accept': '*/*',
    #     'accept-language': 'en-US,en;q=0.9',
    #     'content-type': 'application/x-www-form-urlencoded',
    ...
    # response_Seleccionar_Horas_Trabajadas = requests.request("POST", url_Seleccionar_Horas_Trabajadas,
    #                                                          headers=headers_Seleccionar_Horas_Trabajadas, data=payload_Seleccionar_Horas_Trabajadas)

    # Click Ejecutar
    url_Batch = "https://hst-api.wialon.com/wialon/ajax.html?svc=core/batch&sid=" + sid
    payload_Batch = 'params=%7B%22params%22%3A%5B%7B%22svc%22%3A%22report%2Fcleanup_result%22%2C%22params%22%3A%7B%7D%7D%2C%7B%22svc%22%3A%22report%2Fcleanup_result%22%2C%22params%22%3A%7B%7D%7D%2C%7B%22svc%22%3A%22report%2Fget_report_data%22%2C%22params%22%3A%7B%22itemId%22%3A25005170%2C%22col%22%3A%5B%228%22%5D%2C%22flags%22%3A0%7D%7D%5D%2C%22flags%22%3A0%7D&sid=' + sid
    headers_Batch = {
        'authority': 'hst-api.wialon.com',
        'accept': '*/*',
        'accept-language': 'en-US,en;q=0.9',
    ...
    payload_Write_Log = 'params=%7B%22table%22%3A%22front_stats%22%2C%22stat%22%3A%7B%22feature_type%22%3A4469%2C%22action_type%22%3A446901%2C%22stat_value%22%3A%22%7B%5C%22module%5C%22%3A%5C%22%D0%9E%D1%82%D1%87%D0%B5%D1%82%D1%8B%5C%22%2C%5C%22period%5C%22%3A86399%2C%5C%22periodType%5C%22%3A%5C%22%D0%91%D1%8B%D1%81%D1%82%D1%80%D1%8B%D0%B9%20%D0%BF%D0%B5%D1%80%D0%B8%D0%BE%D0%B4%5C%22%2C%5C%22currentInterval%5C%22%3Anull%2C%5C%22datePickerWasClicked%5C%22%3Anull%7D%22%2C%22time%22%3A' + \
    ...
    if periodo == "Hoy":
        ...
        payload_Exec_Report = "params=%7B%22reportResourceId%22%3A25005170%2C%22reportTemplateId%22%3A8%2C%22reportTemplate%22%3Anull%2C%22reportObjectId%22%3A25676298%2C%22reportObjectSecId%22%3A0%2C%22interval%22%3A%7B%22flags%22%3A16777216%2C%22from%22%3A" + \
            valor_from + "%2C%22to%22%3A" + valor_to + \
            "%7D%2C%22remoteExec%22%3A1%2C%22reportObjectIdList%22%3A%5B23151123%5D%7D&sid=" + sid
    elif periodo == "Ayer":
        valor_from = "0"
        valor_to = "1"
        payload_Exec_Report = 'params=%7B%22reportResourceId%22%3A25005170%2C%22reportTemplateId%22%3A8%2C%22reportTemplate%22%3Anull%2C%22reportObjectId%22%3A25676298%2C%22reportObjectSecId%22%3A0%2C%22interval%22%3A%7B%22from%22%3A' + \
            valor_from + '%2C%22to%22%3A' + valor_to + \
